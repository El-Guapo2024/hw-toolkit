...
from hw_agent.artifacts.project_state.paths import ensure_project, project_dir
from hw_agent.core.subsystem import ElectronicSubsystem, ProjectStatus, SubsystemStatus
